...
parser.add_argument(
    "--video_interval", type=int, default=250, help="Interval between video recordings (in iterations)."
)
...
parser.add_argument("--log_interval", type=int, default=50, help="Iterations between logging metrics.")
parser.add_argument(
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    ...
    print(f"Logger name: {agent_cfg.logger}")
